...
//    }
    ...
    /**
     *
     * @return willl return Location form table
     */
    ...
    /**
     * Sets the appointment_ID, it is autogenerated by the SQL table, and we need to add it to the object to make some functions work
     ...
     * @param customerID customer ID from the ds
     */
